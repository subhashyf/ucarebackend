...
export class OrderEditComponent implements OnInit {
  ...
  exportOrdersCL(event) { event.preventDefault(); alert('exporting ...'); }

  importOrdersCL(event) { event.preventDefault(); alert('importing...'); }
  ...
  exportOrdersSrv(event) { event.preventDefault(); alert('exporting ...'); }

  importOrdersSrv(event) { event.preventDefault(); alert('importing...'); }

  toggleOrderSrvCheckBoxes(event) {
    $('.orderSrvCheckBoxes').each(function() {
      if ($('#orderSrvHeadCheckBox').prop('checked'))
      {
  ...
  deleteOrderSrv(event, id) { event.preventDefault(); alert('do you confirm to delete row id:' + id); }

  deleteOrdersSrv(event):void {
    event.preventDefault();
    if (($('.orderSrvCheckBoxes:checked').length) > 0)
    {
      var Ids = [];
      $('.orderSrvCheckBoxes:checked').each(function(i, e){
    ...
    {
      alert('please select order first on page, then try again...');
    }
  }
  ...
  exportOrdersKYC(event) { event.preventDefault(); alert('exporting ...'); }

  importOrdersKYC(event) { event.preventDefault(); alert('importing...'); }

  toggleOrderKYCCheckBoxes(event) {
    $('.orderKYCCheckBoxes').each(function() {
      if ($('#orderKYCHeadCheckBox').prop('checked'))
      {
        $(this).prop('checked', true);
      }
      else
  ...
  deleteOrderKYC(event, id) { event.preventDefault(); alert('do you confirm to delete row id:' + id); }

  deleteOrdersKYC(event):void {
    event.preventDefault();
    if (($('.orderKYCCheckBoxes:checked').length) > 0)
    {
      var Ids = [];
      $('.orderKYCCheckBoxes:checked').each(function(i, e){
        Ids.push(true); //(evalue);
      });
      alert('do you confirm to delete row ids:' + Ids);
    }
  ...
  exportOrdersDev(event) { event.preventDefault(); alert('exporting ...'); }

  importOrdersDev(event) { event.preventDefault(); alert('importing...'); }

  toggleOrderDevCheckBoxes(event) {
    $('.orderDevCheckBoxes').each(function() {
      if ($('#orderDevHeadCheckBox').prop('checked'))
      {
        $(this).prop('checked', true);
      }
      else
  ...
  deleteOrderDev(event, id) { event.preventDefault(); alert('do you confirm to delete row id:' + id); }

  deleteOrdersDev(event):void {
    event.preventDefault();
    if (($('.orderDevCheckBoxes:checked').length) > 0)
    {
      var Ids = [];
      $('.orderDevCheckBoxes:checked').each(function(i, e){
        Ids.push(true); //(evalue);
      });
      alert('do you confirm to delete row ids:' + Ids);
    }
	...
	orderKYCDocumentEditForm = null;

	orderEditFormSubmit(e) { console.log(e); }

	orderKYCDocumentEditFormSubmit(e) { console.log(e); }
