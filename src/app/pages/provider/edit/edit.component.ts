...
export class ProviderEditComponent implements OnInit {
  ...
  exportProvidersCL(event) { event.preventDefault(); alert('exporting ...'); }

  importProvidersCL(event) { event.preventDefault(); alert('importing...'); }
  ...
  exportProvidersSrv(event) { event.preventDefault(); alert('exporting ...'); }

  importProvidersSrv(event) { event.preventDefault(); alert('importing...'); }

  toggleProviderSrvCheckBoxes(event) {
    $('.providerSrvCheckBoxes').each(function() {
      if ($('#providerSrvHeadCheckBox').prop('checked'))
      {
  ...
  deleteProviderSrv(event, id) { event.preventDefault(); alert('do you confirm to delete row id:' + id); }

  deleteProvidersSrv(event):void {
    event.preventDefault();
    if (($('.providerSrvCheckBoxes:checked').length) > 0)
    {
      var Ids = [];
      $('.providerSrvCheckBoxes:checked').each(function(i, e){
    ...
    {
      alert('please select provider first on page, then try again...');
    }
  }
  ...
  exportProvidersKYC(event) { event.preventDefault(); alert('exporting ...'); }

  importProvidersKYC(event) { event.preventDefault(); alert('importing...'); }

  toggleProviderKYCCheckBoxes(event) {
    $('.providerKYCCheckBoxes').each(function() {
      if ($('#providerKYCHeadCheckBox').prop('checked'))
      {
        $(this).prop('checked', true);
      }
      else
  ...
  deleteProviderKYC(event, id) { event.preventDefault(); alert('do you confirm to delete row id:' + id); }

  deleteProvidersKYC(event):void {
    event.preventDefault();
    if (($('.providerKYCCheckBoxes:checked').length) > 0)
    {
      var Ids = [];
      $('.providerKYCCheckBoxes:checked').each(function(i, e){
        Ids.push(true); //(evalue);
      });
      alert('do you confirm to delete row ids:' + Ids);
    }
  ...
  exportProvidersDev(event) { event.preventDefault(); alert('exporting ...'); }

  importProvidersDev(event) { event.preventDefault(); alert('importing...'); }

  toggleProviderDevCheckBoxes(event) {
    $('.providerDevCheckBoxes').each(function() {
      if ($('#providerDevHeadCheckBox').prop('checked'))
      {
        $(this).prop('checked', true);
      }
      else
  ...
  deleteProviderDev(event, id) { event.preventDefault(); alert('do you confirm to delete row id:' + id); }

  deleteProvidersDev(event):void {
    event.preventDefault();
    if (($('.providerDevCheckBoxes:checked').length) > 0)
    {
      var Ids = [];
      $('.providerDevCheckBoxes:checked').each(function(i, e){
        Ids.push(true); //(evalue);
      });
      alert('do you confirm to delete row ids:' + Ids);
    }
	...
	providerKYCDocumentEditForm = null;

	providerEditFormSubmit(e) { console.log(e); }

	providerKYCDocumentEditFormSubmit(e) { console.log(e); }
