...
export class PackageEditComponent implements OnInit {
  ...
  exportPackagesCL(event) { event.preventDefault(); alert('exporting ...'); }

  importPackagesCL(event) { event.preventDefault(); alert('importing...'); }
  ...
  exportPackagesSrv(event) { event.preventDefault(); alert('exporting ...'); }

  importPackagesSrv(event) { event.preventDefault(); alert('importing...'); }

  togglePackageSrvCheckBoxes(event) {
    $('.packageSrvCheckBoxes').each(function() {
      if ($('#packageSrvHeadCheckBox').prop('checked'))
      {
  ...
  deletePackageSrv(event, id) { event.preventDefault(); alert('do you confirm to delete row id:' + id); }

  deletePackagesSrv(event):void {
    event.preventDefault();
    if (($('.packageSrvCheckBoxes:checked').length) > 0)
    {
      var Ids = [];
      $('.packageSrvCheckBoxes:checked').each(function(i, e){
    ...
    {
      alert('please select package first on page, then try again...');
    }
  }
  ...
  exportPackagesKYC(event) { event.preventDefault(); alert('exporting ...'); }

  importPackagesKYC(event) { event.preventDefault(); alert('importing...'); }

  togglePackageKYCCheckBoxes(event) {
    $('.packageKYCCheckBoxes').each(function() {
      if ($('#packageKYCHeadCheckBox').prop('checked'))
      {
        $(this).prop('checked', true);
      }
      else
  ...
  deletePackageKYC(event, id) { event.preventDefault(); alert('do you confirm to delete row id:' + id); }

  deletePackagesKYC(event):void {
    event.preventDefault();
    if (($('.packageKYCCheckBoxes:checked').length) > 0)
    {
      var Ids = [];
      $('.packageKYCCheckBoxes:checked').each(function(i, e){
        Ids.push(true); //(evalue);
      });
      alert('do you confirm to delete row ids:' + Ids);
    }
  ...
  exportPackagesDev(event) { event.preventDefault(); alert('exporting ...'); }

  importPackagesDev(event) { event.preventDefault(); alert('importing...'); }

  togglePackageDevCheckBoxes(event) {
    $('.packageDevCheckBoxes').each(function() {
      if ($('#packageDevHeadCheckBox').prop('checked'))
      {
        $(this).prop('checked', true);
      }
      else
  ...
  deletePackageDev(event, id) { event.preventDefault(); alert('do you confirm to delete row id:' + id); }

  deletePackagesDev(event):void {
    event.preventDefault();
    if (($('.packageDevCheckBoxes:checked').length) > 0)
    {
      var Ids = [];
      $('.packageDevCheckBoxes:checked').each(function(i, e){
        Ids.push(true); //(evalue);
      });
      alert('do you confirm to delete row ids:' + Ids);
    }
	...
	packageKYCDocumentEditForm = null;

	packageEditFormSubmit(e) { console.log(e); }

	packageKYCDocumentEditFormSubmit(e) { console.log(e); }
