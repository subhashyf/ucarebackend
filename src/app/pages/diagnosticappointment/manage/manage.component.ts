...
export class DiagnosticAppointmentManageComponent {
	baseUrlEdit = "./" + "#/pages/doctorappointment/edit/";
	baseUrlCreate = "./" + "#/pages/doctorappointment/add";
  ...
  deleteProvider(event, id):void { event.preventDefault(); alert('do you confirm to delete row id:' + id); }
}
