...
export class SOSEditComponent implements OnInit {
  ...
  exportSOSsCL(event) { event.preventDefault(); alert('exporting ...'); }

  importSOSsCL(event) { event.preventDefault(); alert('importing...'); }
  ...
  exportSOSsSrv(event) { event.preventDefault(); alert('exporting ...'); }

  importSOSsSrv(event) { event.preventDefault(); alert('importing...'); }

  toggleSOSSrvCheckBoxes(event) {
    $('.sosSrvCheckBoxes').each(function() {
      if ($('#sosSrvHeadCheckBox').prop('checked'))
      {
  ...
  deleteSOSSrv(event, id) { event.preventDefault(); alert('do you confirm to delete row id:' + id); }

  deleteSOSsSrv(event):void {
    event.preventDefault();
    if (($('.sosSrvCheckBoxes:checked').length) > 0)
    {
      var Ids = [];
      $('.sosSrvCheckBoxes:checked').each(function(i, e){
    ...
    {
      alert('please select sos first on page, then try again...');
    }
  }
  ...
  exportSOSsKYC(event) { event.preventDefault(); alert('exporting ...'); }

  importSOSsKYC(event) { event.preventDefault(); alert('importing...'); }

  toggleSOSKYCCheckBoxes(event) {
    $('.sosKYCCheckBoxes').each(function() {
      if ($('#sosKYCHeadCheckBox').prop('checked'))
      {
        $(this).prop('checked', true);
      }
      else
  ...
  deleteSOSKYC(event, id) { event.preventDefault(); alert('do you confirm to delete row id:' + id); }

  deleteSOSsKYC(event):void {
    event.preventDefault();
    if (($('.sosKYCCheckBoxes:checked').length) > 0)
    {
      var Ids = [];
      $('.sosKYCCheckBoxes:checked').each(function(i, e){
        Ids.push(true); //(evalue);
      });
      alert('do you confirm to delete row ids:' + Ids);
    }
  ...
  exportSOSsDev(event) { event.preventDefault(); alert('exporting ...'); }

  importSOSsDev(event) { event.preventDefault(); alert('importing...'); }

  toggleSOSDevCheckBoxes(event) {
    $('.sosDevCheckBoxes').each(function() {
      if ($('#sosDevHeadCheckBox').prop('checked'))
      {
        $(this).prop('checked', true);
      }
      else
  ...
  deleteSOSDev(event, id) { event.preventDefault(); alert('do you confirm to delete row id:' + id); }

  deleteSOSsDev(event):void {
    event.preventDefault();
    if (($('.sosDevCheckBoxes:checked').length) > 0)
    {
      var Ids = [];
      $('.sosDevCheckBoxes:checked').each(function(i, e){
        Ids.push(true); //(evalue);
      });
      alert('do you confirm to delete row ids:' + Ids);
    }
	...
	sosKYCDocumentEditForm = null;

	sosEditFormSubmit(e) { console.log(e); }

	sosKYCDocumentEditFormSubmit(e) { console.log(e); }
